...
<!-- What this change explicitly does NOT do, to keep scope tight. -->

## Capabilities

### New Capabilities
<!-- Capabilities being introduced. Use kebab-case for path segments you introduce
     (e.g., tags-index or blog/tags-index) that follow the project's existing spec
     organization — openspec/specs/ is flat today. Each creates specs/<capability-path>/spec.md. -->
...
<!-- Existing capabilities whose REQUIREMENTS are changing (not just implementation).
     ...
     dependency bumps) must set `skip_specs: true` in its .openspec.yaml - openspec
